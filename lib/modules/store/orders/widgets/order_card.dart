            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style:
                        const TextStyle(color: Palette.greyColor, fontSize: 13),
                  ),
                ],
              ),
              const SizedBox(
              ...
              Row(
                children: [
                  ...
                  Text(
                    order.clientName,
                    style: TextStyle(color: Palette.greyColor, fontSize: 22.sp),
                  ),
                ],
              ),
              const SizedBox(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Text(
                      order.store,
                      style: TextStyle(
                          color: Palette.primaryColor, fontSize: 22.sp),
                    ),
                  ),
                ],
              ),
              ...
              Wrap(
                ...
                children: [
                  ...
                  Text(
                    order.orderStatus,
                    style:
                        TextStyle(color: Palette.primaryColor, fontSize: 22.sp),
                  ),
                ],
              ),
              const SizedBox(
